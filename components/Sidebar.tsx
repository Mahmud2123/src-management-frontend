...
<<<<<<< HEAD
    ...
    { name: 'All Complaints', icon: FileText, path: '/complaints?filter=ALL', show: isSRC },
    ...
    { name: 'Users Management', icon: Users, path: '/users', show: isAdmin },
    { name: 'Audit Logs', icon: Activity, path: '/audit-logs', show: isAdmin },
...
>>>>>>> 67da137888c1abf116aa640e6b5ae33acccf1be7
  ...
  const getRoleBadgeColor = (role: string) => {
    switch (role) {
<<<<<<< HEAD
      case 'ADMIN': return 'bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-200 border-purple-200 dark:border-purple-800';
      case 'SRC_EXECUTIVE': return 'bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-200 border-blue-200 dark:border-blue-800';
      case 'SRC_MEMBER': return 'bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-200 border-green-200 dark:border-green-800';
      case 'CLASS_REP': return 'bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-200 border-orange-200 dark:border-orange-800';
=======
...
>>>>>>> 67da137888c1abf116aa640e6b5ae33acccf1be7
        <div className="flex items-center gap-3">
          ...
          <div>
<<<<<<< HEAD
            <h1 className="text-lg font-bold text-gray-900 dark:text-white transition-colors duration-300">SRC Portal</h1>
            <p className="text-xs text-gray-600 dark:text-gray-400 transition-colors duration-300">Sa'adu Zungur University</p>
=======
...
<<<<<<< HEAD
      <div className="p-6 border-b border-gray-200 dark:border-gray-800 bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-950/30 dark:to-blue-950/30 transition-colors duration-300">
=======
...
<<<<<<< HEAD
            <p className="font-semibold text-gray-900 dark:text-white truncate transition-colors duration-300">{user?.name || 'User'}</p>
            <p className="text-xs text-gray-600 dark:text-gray-400 truncate transition-colors duration-300">{user?.email || 'email@example.com'}</p>
=======
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-200 group relative ${
                active
                  ...
                  : item.highlight
<<<<<<< HEAD
                  ? 'bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 hover:bg-green-100 dark:hover:bg-green-900/50 border-2 border-green-200 dark:border-green-800'
                  : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50'
              }`}
            >
              <Icon 
                className={`w-5 h-5 transition-colors duration-200 ${
                  active ? 'text-white' : item.highlight ? 'text-green-700 dark:text-green-400' : 'text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-200'
                }`} 
              />
              
              <span className={`flex-1 font-medium transition-colors duration-200 ${active ? 'text-white' : 'text-gray-700 dark:text-gray-300'}`}>
                {item.name}
              </span>
...
>>>>>>> 67da137888c1abf116aa640e6b5ae33acccf1be7
      ...
      {/* Footer Actions */}
<<<<<<< HEAD
      <div className="p-4 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300 space-y-2">
        <button
          onClick={toggleTheme}
          className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-all duration-200 group"
        >
          {theme === 'light' ? (
            <>
              <Moon className="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-200" strokeWidth={2.5} />
              <span className="font-medium text-gray-700 dark:text-gray-300 transition-colors duration-200">Dark Mode</span>
            </>
          ) : (
            <>
              <Sun className="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-yellow-500 transition-colors duration-200" strokeWidth={2.5} />
              <span className="font-medium text-gray-700 dark:text-gray-300 transition-colors duration-200">Light Mode</span>
=======
...
<<<<<<< HEAD
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-all duration-200"
        >
          <Settings className="w-5 h-5 text-gray-500 dark:text-gray-400 transition-colors duration-200" />
          <span className="font-medium text-gray-700 dark:text-gray-300 transition-colors duration-200">Settings</span>
        </button>
  ...
  return (
    <>
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-3 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-800 transition-colors duration-300"
      >
        {isMobileOpen ? (
          <X className="w-6 h-6 text-gray-700 dark:text-white transition-colors duration-300" />
        ) : (
          <Menu className="w-6 h-6 text-gray-700 dark:text-white transition-colors duration-300" />
        )}
      </button>
