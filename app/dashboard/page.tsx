        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="p-6 border-0 shadow-lg dark:bg-gray-800 dark:shadow-2xl dark:border-gray-700">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white transition-colors duration-300">Status Distribution</h3>
          ...
          <Card className="p-6 border-0 shadow-lg dark:bg-gray-800 dark:shadow-2xl dark:border-gray-700">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white transition-colors duration-300">Complaints by Category</h3>
          ...
          <Card className="p-6 border-0 shadow-lg dark:bg-gray-800 dark:shadow-2xl dark:border-gray-700">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white transition-colors duration-300">Priority Levels</h3>
                  ...
                  <div key={idx}>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-500 dark:text-gray-400 transition-colors duration-300">({percentage}%)</span>
                      </div>
                    </div>
          ...
          <Card className="p-6 border-0 shadow-xl bg-white dark:bg-gray-800 dark:shadow-2xl dark:border-gray-700">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h3 className="text-xl font-extrabold text-gray-900 dark:text-white transition-colors duration-300">Recent Activity</h3>
